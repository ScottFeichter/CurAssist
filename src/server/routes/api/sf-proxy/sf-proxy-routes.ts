 ...
 * The SFSG API has open CORS (access-control-allow-origin: *) and requires
 * no authentication or cookies. The browser could call it directly.
 * This proxy exists solely for server-side logging and observability —
 * it lets us inspect request payloads and SFSG responses in our server logs
 * without relying on the browser console.
 */
